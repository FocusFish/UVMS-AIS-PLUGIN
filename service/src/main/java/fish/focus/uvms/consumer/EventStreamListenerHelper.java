...
public class EventStreamListenerHelper {

    private static final Logger LOG = LoggerFactory.getLogger(EventStreamListenerHelper.class);

    public static void addFishingVesselonMessage(Jsonb jsonb, AisService aisService, Message inMessage) {
